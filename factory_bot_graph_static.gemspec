...
require_relative "lib/factory_bot_graph_static/version"

Gem::Specification.new do |spec|
  spec.name = "factory_bot_graph_static"
  spec.version = FactoryBotGraphStatic::VERSION
  ...
  spec.bindir = "bin"
  spec.executables = ["factory_bot_graph_static"]
